#ifndef LLM_FROZEN_LEGACY_PER_SM_L1_H
#define LLM_FROZEN_LEGACY_PER_SM_L1_H
...
namespace llm_legacy_l1 {
namespace retry_host = GTSim::retry_host;
...
#endif  // LLM_FROZEN_LEGACY_PER_SM_L1_H
