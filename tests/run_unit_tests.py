        ...
        if run['returncode'] == 0:
            try:
                ...
                if name == 'dirty32_test':
                    ...
                    expected = {'ada_l1_clock_test':'PASS_ADA_L1_CLOCK',
                                'ada_l1_policy_test':'PASS_ADA_L1_POLICY',
