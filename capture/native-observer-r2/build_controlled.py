...
def main():
    ...
    plan = dict(schema='OBSERVER_R2_CPU45_BUILD_PLAN_V1', argv=argv, cpu=45, lease=str(LOCK),
    ...
    logs = TASK / 'runs' / 'observer-r2-build'
    ...
    try:
        ...
        with (logs / 'stdout.log').open('xb') as stdout, (logs / 'stderr.log').open('xb') as stderr:
            ...
            result['returncode'] = child.wait(timeout=720)
